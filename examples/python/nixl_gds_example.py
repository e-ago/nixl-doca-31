...
if __name__ == "__main__":
    ...
    logger.debug(nixl_agent1.get_plugin_mem_types("GDS"))
    logger.debug(nixl_agent1.get_plugin_params("GDS"))

    nixl_agent1.create_backend("GDS")

    logger.info("Loaded backend parameters")
    logger.debug(nixl_agent1.get_backend_mem_types("GDS"))
    logger.debug(nixl_agent1.get_backend_params("GDS"))
    logger.info("")
