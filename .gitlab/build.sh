...
wget --tries=3 --waitretry=5 --no-verbose https://urm.nvidia.com/artifactory/sw-nbu-int-generic-local/doca-repo-3.2.0/doca-repo-3.2.0-115000/doca-host_3.2.0-115000-25.10-${MELLANOX_OS}_${ARCH_SUFFIX}.deb -O doca-host.deb
